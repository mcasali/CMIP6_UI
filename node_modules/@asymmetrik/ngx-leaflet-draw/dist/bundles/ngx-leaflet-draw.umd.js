...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ngxLeafletDraw = {}, global.ng.core, global.ngxLeaflet, global.L));
}(this, (function (exports, core, ngxLeaflet, leaflet) { 'use strict';
    ...
    var LeafletDrawUtil = /** @class */ (function () {
         ...
         * @param src
         */
        LeafletDrawUtil.deepLiteralCopy = function (dest, src) {
            var toReturn = dest;
            if (null != src) {
                for (var k in src) {
    ...
    var LeafletDrawDirective = /** @class */ (function () {
        ...
        LeafletDrawDirective.prototype.ngOnInit = function () {
            ...
            if (null != this.drawLocal) {
                LeafletDrawUtil.deepLiteralCopy(leaflet.drawLocal, this.drawLocal);
            }
            // Create the control
            this.drawControl = new leaflet.Control.Draw(this.drawOptions);
            // Add the control to the map
            this.leafletDirective.getMap().addControl(this.drawControl);
            // Register the main handler for events coming from the draw plugin
            var map = this.leafletDirective.getMap();
            // add draw event pass throughs
            map.on(leaflet.Draw.Event.CREATED, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawCreated, e); });
            map.on(leaflet.Draw.Event.EDITED, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEdited, e); });
            map.on(leaflet.Draw.Event.DELETED, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawDeleted, e); });
            map.on(leaflet.Draw.Event.DRAWSTART, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawStart, e); });
            map.on(leaflet.Draw.Event.DRAWSTOP, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawStop, e); });
            map.on(leaflet.Draw.Event.EDITSTART, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEditStart, e); });
            map.on(leaflet.Draw.Event.EDITMOVE, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEditMove, e); });
            map.on(leaflet.Draw.Event.EDITRESIZE, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEditResize, e); });
            map.on(leaflet.Draw.Event.EDITVERTEX, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEditVertex, e); });
            map.on(leaflet.Draw.Event.EDITSTOP, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawEditStop, e); });
            map.on(leaflet.Draw.Event.DELETESTART, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawDeleteStart, e); });
            map.on(leaflet.Draw.Event.DELETESTOP, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawDeleteStop, e); });
            map.on(leaflet.Draw.Event.TOOLBAROPENED, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawToolbarOpened, e); });
            map.on(leaflet.Draw.Event.TOOLBARCLOSED, function (e) { return ngxLeaflet.LeafletUtil.handleEvent(_this.zone, _this.onDrawToolbarClosed, e); });
        ...
        LeafletDrawDirective.propDecorators = {
            ...
            drawLocal: [{ type: core.Input, args: ['leafletDrawLocal',] }],
...
//# sourceMappingURL=ngx-leaflet-draw.umd.js.map
