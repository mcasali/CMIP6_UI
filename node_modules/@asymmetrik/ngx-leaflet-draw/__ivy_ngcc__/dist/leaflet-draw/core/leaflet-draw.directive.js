...
LeafletDrawDirective.ɵfac = function LeafletDrawDirective_Factory(t) { return new (t || LeafletDrawDirective)(ɵngcc0.ɵɵdirectiveInject(LeafletDirective), ɵngcc0.ɵɵdirectiveInject(NgZone)); };
LeafletDrawDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LeafletDrawDirective, selectors: [["", "leafletDraw", ""]], inputs: { drawOptions: ["leafletDrawOptions", "drawOptions"], drawLocal: ["leafletDrawLocal", "drawLocal"] }, outputs: { drawReady: "leafletDrawReady", onDrawCreated: "leafletDrawCreated", onDrawEdited: "leafletDrawEdited", onDrawDeleted: "leafletDrawDeleted", onDrawStart: "leafletDrawStart", onDrawStop: "leafletDrawStop", onDrawVertex: "leafletDrawVertex", onDrawEditStart: "leafletDrawEditStart", onDrawEditMove: "leafletDrawEditMove", onDrawEditResize: "leafletDrawEditResize", onDrawEditVertex: "leafletDrawEditVertex", onDrawEditStop: "leafletDrawEditStop", onDrawDeleteStart: "leafletDrawDeleteStart", onDrawDeleteStop: "leafletDrawDeleteStop", onDrawToolbarOpened: "leafletDrawToolbarOpened", onDrawToolbarClosed: "leafletDrawToolbarClosed", onDrawMarkerContext: "leafletDrawMarkerContext" } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LeafletDrawDirective, [{
        type: Directive,
        args: [{
                selector: '[leafletDraw]'
            }]
    }], function () { return [{ type: LeafletDirective }, { type: NgZone }]; }, { drawOptions: [{
            type: Input,
